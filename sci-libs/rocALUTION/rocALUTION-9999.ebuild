...
EGIT_REPO_URI="https://github.com/ROCmSoftwarePlatform/rocALUTION.git"
EGIT_BRANCH="master"
...
RDEPEND="hip? ( >=sys-devel/hip-3.9.0 )
	 hip? ( =sci-libs/rocSPARSE-9999 )
	 hip? ( >=sci-libs/rocBLAS-3.8.0 )
	 mpi? ( virtual/mpi )
